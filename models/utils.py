...
def compute_metrics(res, num_classes, multi_label=False):
    if not multi_label:
        ...
        metrics = {
            ...
            "precision_weighted": Precision(task="multiclass", num_classes=num_classes, average="weighted").to(device),
            "precision_macro" : Precision(task="multiclass", num_classes=num_classes, average="macro").to(device),
            "recall_weighted": Recall(task="multiclass", num_classes=num_classes, average="weighted").to(device),
